(ns benwiz.melodex.views
  (:require
   ...
   [benwiz.melodex.views.about :as about]
   [benwiz.melodex.views.analysis :as analysis]
   [benwiz.melodex.views.genre-playlists :as genre-playlists]
   [benwiz.melodex.views.home :as home]
   [benwiz.melodex.views.powerhour :as powerhour]
   [benwiz.melodex.views.settings :as settings]
   [benwiz.melodex.views.search :as search]
   [benwiz.melodex.views.spotifylogin :as spotifylogin]
   [benwiz.melodex.views.wwoz-to-spotify :as wwoz-to-spotify]
...
(defn main-panel []
  (let [active-panel (rf/subscribe [::subs/db :active-panel])]
    [:> CssVarsProvider {:theme theme
                         ;; :defaultMode "dark"
                         ;; :modeStorageKey       "melodex_joy-system-mode"
